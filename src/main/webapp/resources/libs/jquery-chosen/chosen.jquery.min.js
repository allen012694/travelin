...
(function() {
    var $, AbstractChosen, Chosen, SelectParser, _ref, __hasProp = {}.hasOwnProperty, __extends = function(child,
            parent) {
    ...
    AbstractChosen = (function() {
        ...
        AbstractChosen.prototype.set_default_values = function() {
            ...
            this.allow_single_deselect = (this.options.allow_single_deselect != null)
                    && (this.form_field.options[0] != null) && this.form_field.options[0].text === "" ? this.options.allow_single_deselect
                    : false;
        ...
        AbstractChosen.prototype.strip_diacritics = function(string) {
            var translationTable = [
                    "áàạảãăắằặẳẵâấầậẩẫđéèẹẻẽêếềệễểíìỉĩịóòọỏõôốồộổỗơớờợởỡúùủũụưứừửữựýỳỷỹỵÁÀẠẢÃĂẮẰẶẲẴÂẤẦẬẨẪĐÉÈẸẺẼÊẾỀỆỄỂÍÌỈĨỊÓÒỌỎÕÔỐỒỘỔỖƠỚỜỢỞỠÚÙỦŨỤƯỨỪỬỮỰÝỲỶỸỴ",
                    "aaaaaaaaaaaaaaaaadeeeeeeeeeeeiiiiiooooooooooooooooouuuuuuuuuuuyyyyyAAAAAAAAAAAAAAAAADEEEEEEEEEEEIIIIIOOOOOOOOOOOOOOOOOUUUUUUUUUUUYYYYY" ], output = '';
            ...
            for (_i = 0, _len = _ref.length; _i < _len; _i++) {
                ...
                if (this.include_option_in_results(option)) {
                    ...
                    if (!(option.group && !this.group_search)) {
                        option.search_match = this
                                .search_string_match(this.strip_diacritics(option.search_text), regex);
    ...
    Chosen = (function(_super) {
                ...
                if (!((evt != null) && ($(evt.target)).hasClass("search-choice-close"))) {
                    if (!this.active_field) {
                        ...
                        this.results_show();
                            ...
                            && evt
                            && (($(evt.target)[0] === this.selected_item[0]) || $(evt.target)
        ...
        Chosen.prototype.search_results_mouseup = function(evt) {
            var target;
            target = $(evt.target).hasClass("active-result") ? $(evt.target) : $(evt.target).parents(".active-result")
                    .first();
            if (target.length) {
        ...
        Chosen.prototype.winnow_results_set_highlight = function() {
            ...
            do_high = selected_results.length ? selected_results.first() : this.search_results.find(".active-result")
                    .first();
            if (do_high != null) {
